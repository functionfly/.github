...
// resolveAuthorName resolves author and name from command args or manifest+credentials.
// If args contains "author/name", parses it directly; otherwise loads the manifest
// for the function name and credentials for the author.
func resolveAuthorName(args []string) (string, string, error) {
