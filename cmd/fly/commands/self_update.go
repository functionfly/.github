...
The fly CLI does not replace its own binary. Use one of these methods:
  ...
  https://github.com/functionfly/functionfly/releases
...
func runSelfUpdate(cmd *cobra.Command, args []string) error {
	...
	fmt.Println("    curl -fsSL https://raw.githubusercontent.com/functionfly/functionfly/main/scripts/install.sh | bash")
	fmt.Println()
	...
	fmt.Println()
	fmt.Println("  Releases: https://github.com/functionfly/functionfly/releases")
	return nil
}
