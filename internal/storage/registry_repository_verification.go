...
// ============================================
// Function Content Verification Methods
// ============================================

// CreateFunctionSignature creates a new function signature
func (r *RegistryRepository) CreateFunctionSignature(sig *registry.RegistryFunctionSignature) error {
	sig.ID = uuid.New()
...
func (r *RegistryRepository) GetFunctionSignatures(functionVersionID uuid.UUID) ([]registry.RegistryFunctionSignature, error) {
	var signatures []registry.RegistryFunctionSignature
...
func (r *RegistryRepository) CreateMalwareScan(scan *registry.RegistryFunctionMalwareScan) error {
	scan.ID = uuid.New()
...
func (r *RegistryRepository) GetLatestMalwareScan(functionVersionID uuid.UUID) (*registry.RegistryFunctionMalwareScan, error) {
	var scan registry.RegistryFunctionMalwareScan
...
func (r *RegistryRepository) CreateFunctionApproval(approval *registry.RegistryFunctionApproval) error {
...
func (r *RegistryRepository) GetFunctionApprovals(functionVersionID uuid.UUID) ([]registry.RegistryFunctionApproval, error) {
	var approvals []registry.RegistryFunctionApproval
	if err := r.db.Where("function_version_id = ?", functionVersionID).
		Preload("RequestedBy").
		Preload("AssignedTo").
		Preload("ApprovedBy").
...
func (r *RegistryRepository) UpdateFunctionApproval(approvalID uuid.UUID, updates map[string]interface{}) error {
	...
	if err := r.db.Model(&registry.RegistryFunctionApproval{}).
		Where("id = ?", approvalID).
...
func (r *RegistryRepository) CreateApprovalComment(comment *registry.RegistryFunctionApprovalComment) error {
	comment.ID = uuid.New()
...
func (r *RegistryRepository) GetApprovalComments(approvalID uuid.UUID) ([]registry.RegistryFunctionApprovalComment, error) {
	var comments []registry.RegistryFunctionApprovalComment
...
func (r *RegistryRepository) CreateOrUpdateVerificationStatus(status *registry.RegistryFunctionVerificationStatus) error {
	status.UpdatedAt = time.Now()

	// Try to update existing status
	result := r.db.Model(&registry.RegistryFunctionVerificationStatus{}).
...
func (r *RegistryRepository) GetVerificationStatus(functionVersionID uuid.UUID) (*registry.RegistryFunctionVerificationStatus, error) {
	var status registry.RegistryFunctionVerificationStatus
...
func (r *RegistryRepository) GetSignatureByID(signatureID uuid.UUID) (*registry.RegistryFunctionSignature, error) {
	var sig registry.RegistryFunctionSignature
...
func (r *RegistryRepository) UpdateSignature(signatureID uuid.UUID, updates map[string]interface{}) error {
	...
	if err := r.db.Model(&registry.RegistryFunctionSignature{}).
...
func (r *RegistryRepository) GetApprovalByID(approvalID uuid.UUID) (*registry.RegistryFunctionApproval, error) {
	var approval registry.RegistryFunctionApproval
