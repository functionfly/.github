...
func registerRegistryRoutes(
	...
	// ── Function Versions (platform management) ─────────────────────────────
	api.HandleFunc("/v1/platform/functions/{functionId}/versions", versionHandler.HandleListFunctionVersions).Methods("GET", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/versions/{version}", versionHandler.HandleGetFunctionVersion).Methods("GET", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/versions/{version}/changelog", authMiddleware.RequireAuth(versionHandler.HandleCreateChangelog)).Methods("POST", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/changelogs", versionHandler.HandleGetChangelogs).Methods("GET", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/versions/{version}/publish", authMiddleware.RequireAuth(versionHandler.HandlePublishVersion)).Methods("POST", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/versions/{version}/archive", authMiddleware.RequireAuth(versionHandler.HandleArchiveVersion)).Methods("POST", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/versions/{version}/deprecate", authMiddleware.RequireAuth(versionHandler.HandleDeprecateFunctionVersion)).Methods("POST", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/versions/{version}/alias/{alias}", authMiddleware.RequireAuth(versionHandler.HandleSetAlias)).Methods("POST", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/versions/{version}/rollback", authMiddleware.RequireAuth(versionHandler.HandleRollbackVersion)).Methods("POST", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/rollback", authMiddleware.RequireAuth(versionHandler.HandleRollbackLatest)).Methods("POST", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/rollbacks", versionHandler.HandleGetRollbackHistory).Methods("GET", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/versions/{version}/deployments", versionHandler.HandleListDeployments).Methods("GET", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/versions/{version}/deployments/{deploymentId}", versionHandler.HandleGetDeployment).Methods("GET", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/versions/{version}/lineage", versionHandler.HandleGetVersionLineage).Methods("GET", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/versions/compare", versionHandler.HandleCompareVersions).Methods("GET", "OPTIONS")
	api.HandleFunc("/v1/platform/functions/{functionId}/trust", registryHandler.HandleGetTrustScore).Methods("GET")
	api.HandleFunc("/v1/platform/functions/{functionId}/trust/history", registryHandler.HandleGetTrustHistory).Methods("GET")
	api.HandleFunc("/v1/platform/functions/{functionId}/trust/refresh", authMiddleware.RequireAuth(registryHandler.HandleRefreshTrustScore)).Methods("POST")
