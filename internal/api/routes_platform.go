...
func registerPlatformRoutes(
	...
	protected.HandleFunc("/teams/{teamId}/members", authMiddleware.RequireAuth(teamHandler.HandleListTeamMembers)).Methods("GET")
	...
	protected.HandleFunc("/teams/{teamId}/members/leave", authMiddleware.RequireAuth(teamHandler.HandleLeaveTeam)).Methods("POST")
	protected.HandleFunc("/teams/{teamId}/transfer-ownership", authMiddleware.RequireAuth(teamHandler.HandleTransferOwnership)).Methods("POST")
	protected.HandleFunc("/teams/{teamId}/audit-logs", authMiddleware.RequireAuth(teamHandler.HandleGetTeamAuditLogs)).Methods("GET")
	protected.HandleFunc("/teams/{teamId}/quotas", authMiddleware.RequireAuth(teamHandler.HandleGetTeamQuotas)).Methods("GET")
	...
	protected.HandleFunc("/apps/{appId}", authMiddleware.RequireAuth(appsHandler.HandleUpdateApp)).Methods("PATCH", "OPTIONS")
	protected.HandleFunc("/apps/{appId}", authMiddleware.RequireAuth(appsHandler.HandleDeleteApp)).Methods("DELETE", "OPTIONS")
	protected.HandleFunc("/apps/{appId}/status", authMiddleware.RequireAuth(appsHandler.HandleGetAppStatus)).Methods("GET", "OPTIONS")
	protected.HandleFunc("/apps/{appId}/analytics", authMiddleware.RequireAuth(appsHandler.HandleGetAppAnalytics)).Methods("GET", "OPTIONS")
	...
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleGet))).Methods("GET", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleUpdate))).Methods("PATCH", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleDelete))).Methods("DELETE", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/metrics", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleGetMetrics))).Methods("GET", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/stores", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleListStores))).Methods("GET", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/stores", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleCreateStore))).Methods("POST", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/stores/{storeId:[0-9a-fA-F-]{36}}", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleDeleteStore))).Methods("DELETE", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/pipelines", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleListPipelines))).Methods("GET", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/pipelines", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleCreatePipeline))).Methods("POST", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/pipelines/{pipelineId:[0-9a-fA-F-]{36}}", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleUpdatePipeline))).Methods("PATCH", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/pipelines/{pipelineId:[0-9a-fA-F-]{36}}", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleDeletePipeline))).Methods("DELETE", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/pipelines/{pipelineId:[0-9a-fA-F-]{36}}/execute", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleExecutePipeline))).Methods("POST", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/events", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleListEvents))).Methods("GET", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/snapshots", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleListSnapshots))).Methods("GET", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/snapshots", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleCreateSnapshot))).Methods("POST", "OPTIONS")
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/snapshots/{snapshotId:[0-9a-fA-F-]{36}}", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleDeleteSnapshot))).Methods("DELETE", "OPTIONS")
	...
	protected.HandleFunc("/state-fabrics/{id:[0-9a-fA-F-]{36}}/triggers/{triggerId:[0-9a-fA-F-]{36}}", advancedSecurityMiddleware.AdvancedRateLimit(authMiddleware.RequireAuth(stateFabricHandler.HandleDeleteTrigger))).Methods("DELETE", "OPTIONS")
