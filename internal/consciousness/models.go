...
func (c InsightCategory) IsValid() bool {
	switch c {
	case CategoryTraffic, CategoryCost, CategoryRedundancy, CategoryHealth, CategoryMarketplace, CategoryScaling:
		return true
	}
	return false
}
...
func (s InsightSeverity) IsValid() bool {
	switch s {
	case SeverityInfo, SeverityWarning, SeverityCritical, SeverityOpportunity:
		return true
	}
	return false
}
...
func (s InsightStatus) IsValid() bool {
	switch s {
	case StatusActive, StatusDismissed, StatusApplied, StatusExpired, StatusSuperseded:
		return true
	}
	return false
}
