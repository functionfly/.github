...
import { platformSettingsStore } from '@/stores/platformSettingsStore';
...
export function AdminSystemPage() {
  ...
  const handleSavePlatformSettings = async () => {
    ...
    const settings: PlatformSettingsState = {
      maintenanceMode: platformSettings.maintenanceMode,
      signupsEnabled: platformSettings.signupsEnabled,
      platformName: platformSettings.platformName,
      supportEmail: platformSettings.supportEmail,
      defaultRateLimitPerMin: platformSettings.defaultRateLimitPerMin,
    };

    try {
      await adminApiClient.patch('/state-fabrics/settings', settings);
    } catch {
                ...
                <div className="p-6 space-y-6">
                  <div className="flex items-center justify-between gap-6 py-2">
                    ...
                    <Switch
                      ...
                      onChange={(v) => setPlatformSettings((s) => ({ ...s, maintenanceMode: v }))}
                    />
                  </div>
                  <div className="flex items-center justify-between gap-6 py-2">
                    <div className="min-w-0">
                    ...
                    <Switch
                      ...
                      onChange={(v) => setPlatformSettings((s) => ({ ...s, signupsEnabled: v }))}
                    />
                  </div>
