...
import { Package, RefreshCw, ExternalLink, Clock } from 'lucide-react';
import { factoryApi, type PublishedFunction } from '@/lib/api/factory';
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
        ...
        <div className="overflow-x-auto">
          ...
          ) : publishedFunctions.length === 0 && versions.length === 0 ? (
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                  ...
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">Runtime</th>
              ...
              <tbody>
                {publishedFunctions.map((fn) => (
                  <tr key={fn.id} className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    ...
                    <td className="py-3 px-4">
                      <span className="text-sm text-gray-600 dark:text-gray-400">v{fn.version}</span>
                    </td>
