...
import { AlertTriangle, Building2, Globe, Lock, RefreshCw, Settings, Unplug } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  {isConnected ? `Connected as @${connection.github_username}` : 'Not connected'}
                </CardDescription>
              </div>
            </div>
            {isConnected ? (
      ...
      <Card className="opacity-60">
        ...
        <CardContent>
          <p className="text-sm text-text-muted">
            Enterprise GitHub App integration will allow organization admins to manage imports
            across all repositories with fine-grained permissions.
          </p>
        </CardContent>
      </Card>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>Default settings for new GitHub imports</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-text-muted">Enable auto-sync for new imports</p>
              </div>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>Irreversible actions for your GitHub connection</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
