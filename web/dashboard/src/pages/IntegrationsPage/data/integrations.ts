...
export const integrationCategories: IntegrationCategory[] = [
  ...
  },
  {
    ...
    description:
      'Connect FunctionFly trusted tools directly into LangChain, AutoGen, and CrewAI agents',
    color: '#a855f7',
    icon: 'bot',
  },
];
...
export const integrations: Integration[] = [
  // Cloud Providers
  {
    ...
    description:
      'Deploy serverless functions to AWS Lambda with automatic scaling, monitoring, and cost optimization.',
    icon: AwsIcon,
    features: [
      'Automatic scaling',
      '99.9% uptime SLA',
  ...
  },
  {
    ...
    category: 'Cloud Providers',
    description:
      "Build and deploy serverless functions with Netlify's developer-friendly platform.",
    icon: NetlifyIcon,
    features: [
      '175+ edge locations',
      'Build hooks',
  ...
  // Deployment Platforms
  {
    ...
    description:
      'Infrastructure platform that makes deployment effortless with databases and more.',
    icon: RailwayIcon,
    features: [
      'Database hosting',
      'Environment variables',
  ...
  // AI Agent Frameworks
  {
    ...
    description:
      'Load FunctionFly trusted tools directly into LangChain agents as StructuredTools, with trust-policy enforcement and full execution metadata.',
    icon: LangChainIcon,
    features: [
      ...
      'Verified-only tool discovery',
      'pip install flypy[agents-langchain]',
    ],
    setupTime: '2 minutes',
    documentation: {
      guide: 'https://docs.functionfly.com/integrations/langchain',
      api: 'https://docs.functionfly.com/api/integrations/langchain',
      examples: 'https://docs.functionfly.com/examples/langchain',
    },
    status: 'available',
    popularity: 'high',
  },
  {
    ...
    category: 'AI Agent Frameworks',
    description:
      'Register FunctionFly trusted tools as AutoGen function tools, with trust scoring, capability allow/deny, and full execution envelope.',
    icon: AutoGenIcon,
    features: [
    ...
    setupTime: '2 minutes',
    documentation: {
      guide: 'https://docs.functionfly.com/integrations/autogen',
      api: 'https://docs.functionfly.com/api/integrations/autogen',
      examples: 'https://docs.functionfly.com/examples/autogen',
    },
    status: 'available',
    popularity: 'high',
  },
  {
    ...
    category: 'AI Agent Frameworks',
    description:
      'Equip CrewAI crews with FunctionFly trusted actions. Trust policy enforced at discovery time, not at execution time.',
    icon: CrewAIIcon,
    features: [
      'Crew action registration',
    ...
    setupTime: '2 minutes',
    documentation: {
      guide: 'https://docs.functionfly.com/integrations/crewai',
      api: 'https://docs.functionfly.com/api/integrations/crewai',
      examples: 'https://docs.functionfly.com/examples/crewai',
    },
    status: 'available',
    popularity: 'medium',
  },
