...
export function getApiErrorMessage(
  ...
  if (data && typeof data === "object" && data !== null && "error" in data) {
    ...
    if (errorObj && typeof errorObj.message === "string" && errorObj.message) return errorObj.message;
  }
...
export const VALID_TABS = ["account", "billing", "api", "notifications", "privacy"] as const;
