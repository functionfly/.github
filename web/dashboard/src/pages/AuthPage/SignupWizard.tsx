...
import { Zap, Eye, EyeOff, Shield, Check, X, User, Mail, Key, AtSign, Building2, ArrowRight, ArrowLeft, Loader2 } from "lucide-react";
...
function Step1EmailPassword({ 
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-text-muted text-center mb-4">Start with your email and a secure password</p>
...
function Step2Profile({ 
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-text-muted text-center mb-4">This helps us personalize your experience</p>
      ...
      <div className="space-y-2">
        ...
        />
        {errors.name && (
          <div className="text-xs text-error">{errors.name.message}</div>
        )}
      </div>
      ...
      <div className="space-y-2">
        ...
        />
        {errors.username && (
          <div className="text-xs text-error">{errors.username.message}</div>
        )}
      </div>
    </div>
  );
...
function Step3Optional({ 
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-text-muted text-center mb-4">Add optional details or skip this step</p>
      ...
      <div className="space-y-2">
        ...
        />
        {errors.inviteCode && (
          <div className="text-xs text-error">{errors.inviteCode.message}</div>
        )}
      </div>
