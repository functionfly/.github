 ...
 */
export function StateFabricPricingSection() {
  ...
  return (
    <motion.section
      ...
      className="pricing-state-fabric-section mb-24"
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 max-w-7xl mx-auto">
        {STATE_FABRIC_PLANS.map((plan, index) => (
          <StateFabricPricingCard key={plan.id} plan={plan} index={index} inView={inView} />
        ))}
      </div>
