...
export function ConnectorsPage() {
  ...
  return (
    <div className="space-y-8">
      <MetaTags
        title="Connectors | FunctionFly"
        description="Link external accounts to expand your Brain's knowledge. Connect GitHub, Notion, Slack, Gmail, and Linear."
      />
      ...
      {/* Empty state for linked connectors */}
      {userConnectors.length === 0 && (
        <EmptyState
          variant="card"
