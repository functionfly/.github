...
import { Users, Heart, Shield, Award, Coffee, Code, Lightbulb, ArrowLeft } from "lucide-react";
...
export function TeamPage() {
  return (
    <div className="min-h-screen bg-bg-primary">
      {/* SEO Meta Tags */}
      <MetaTags
        title="Team | FunctionFly - Meet the Engineers Behind Serverless Reliability"
        description="Meet the FunctionFly team: engineers from AWS, Netflix, Stripe, and Twilio who build reliable serverless systems. Learn our story and mission to eliminate serverless outages."
        keywords={["functionfly team", "serverless engineers", "aws engineers", "netflix engineers", "serverless reliability", "team", "about us", "company"]}
        url="/team"
      />

      {/* Navigation Bar */}
      <nav className="border-b border-white/8 bg-black/20 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-2 text-white hover:text-[#6366f1] transition-colors">
              <ArrowLeft className="w-5 h-5" />
              <span className="font-medium">Back to Home</span>
            </Link>
            <h1 className="text-xl font-bold text-white">FunctionFly Team</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-12">
          ...
          <Card className="border-[#6366f1]/30 bg-[#6366f1]/5 max-w-4xl mx-auto">
            <CardContent className="p-8 lg:p-12">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-white mb-4">Why We Built FunctionFly</h2>
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">The Team Behind FunctionFly</h2>
            <p className="text-text-secondary max-w-2xl mx-auto text-lg">
