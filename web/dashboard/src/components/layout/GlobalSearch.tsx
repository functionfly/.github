  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl bg-bg-secondary border-border-subtle p-0 gap-0">
              ...
              {filteredResults.map((result, index) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'w-full px-6 py-3 flex items-center gap-4 hover:bg-bg-hover transition-colors text-left',
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {result.badge && (
                          <Badge
                            variant="outline"
                            className={cn(
                              'text-xs px-2 py-0.5 border-border-subtle',
        ...
        <div className="px-6 py-3 border-t border-border-subtle bg-bg-tertiary">
