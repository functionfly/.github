...
const generateMockIntents = () => [
  {
    ...
    affectedCodeRanges: [{ start: { line: 1 }, end: { line: 50 } }],
  ...
  },
  {
    ...
    affectedCodeRanges: [{ start: { line: 100 }, end: { line: 150 } }],
  ...
  },
  {
    ...
    affectedCodeRanges: [{ start: { line: 75 }, end: { line: 90 } }],
...
const generateMockRisks = () => [
  {
    ...
    location: { start: { line: 42 }, end: { line: 42 } },
  ...
  },
  {
    ...
    location: { start: { line: 88 }, end: { line: 95 } },
...
const generateMockCompletions = () => [
  ...
  try {
    ...
    latency: 450,
    tokens: 125,
    context: { filePath: 'src/components/Form.tsx', language: 'typescript' },
  },
  {
    id: 'comp-2',
    text: `const handleSubmit = async (formData: FormData) => {
  ...
  const [refactorOpportunities] = useState([
    {
      ...
      location: { start: { line: 12 }, end: { line: 20 } },
    ...
    },
    {
      ...
      location: { start: { line: 10 }, end: { line: 10 } },
