...
import { Copy, Check, Bot, ExternalLink } from "lucide-react";
...
export function AIDiscoveryUrlCard() {
  ...
  return (
    <Card className="border-theme bg-card/80">
      <CardHeader className="pb-2">
        ...
        <CardDescription>
          Public manifest for LLMs and agents. Fetch this URL to get OpenAI-compatible tool schemas for all public functions.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-3">
        <div className="flex items-center gap-2 rounded-lg bg-bg-secondary px-3 py-2 font-mono text-sm text-text-secondary break-all">
        ...
        <Link
          to="/docs/agent-ai-llm-integration"
