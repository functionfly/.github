...
import { getCanonicalNavPath, ROUTE_BUILDERS, ROUTES } from './constants';
...
describe('getCanonicalNavPath', () => {
  ...
  it('returns null for admin paths (admin dashboard is a separate app)', () => {
    expect(getCanonicalNavPath('/admin/tenants/abc')).toBeNull();
  });
