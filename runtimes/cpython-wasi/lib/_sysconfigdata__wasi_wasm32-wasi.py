...
build_time_vars = {
    ...
    'AR': '/home/micro/projects/functionfly/runtimes/wasi-sdk/bin/llvm-ar',
    'ARFLAGS': 'rcs',
    ...
    'BLDSHARED': '/home/micro/projects/functionfly/runtimes/wasi-sdk/bin/clang --sysroot=/home/micro/projects/functionfly/runtimes/wasi-sdk/share/wasi-sysroot -shared',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.wasm',
    ...
    'BYTESTR_DEPS': '\\',
    'CC': '/home/micro/projects/functionfly/runtimes/wasi-sdk/bin/clang --sysroot=/home/micro/projects/functionfly/runtimes/wasi-sdk/share/wasi-sysroot',
    'CCSHARED': '',
    ...
    'CONFIG_ARGS': "'-C' '--host=wasm32-unknown-wasi' '--build=x86_64-pc-linux-gnu' '--with-build-python=../build/python' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=wasm32-unknown-wasi' 'PKG_CONFIG_PATH=' 'PKG_CONFIG_LIBDIR=/home/micro/projects/functionfly/runtimes/wasi-sdk/share/wasi-sysroot/lib/pkgconfig:/home/micro/projects/functionfly/runtimes/wasi-sdk/share/wasi-sysroot/share/pkgconfig' 'CC=/home/micro/projects/functionfly/runtimes/wasi-sdk/bin/clang --sysroot=/home/micro/projects/functionfly/runtimes/wasi-sdk/share/wasi-sysroot' 'CPP=/home/micro/projects/functionfly/runtimes/wasi-sdk/bin/clang-cpp --sysroot=/home/micro/projects/functionfly/runtimes/wasi-sdk/share/wasi-sysroot' 'HOSTRUNNER=wasmtime run --mapdir /::/home/micro/projects/functionfly/runtimes/cpython-src --env PYTHONPATH=/builddir/wasi/build/lib.wasi-wasm32-3.13 /home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi/python.wasm --'",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi/lcov-report',
    ...
    'CXX': '/home/micro/projects/functionfly/runtimes/wasi-sdk/bin/clang++ --sysroot=/home/micro/projects/functionfly/runtimes/wasi-sdk/share/wasi-sysroot',
    ...
    'FREEZE_MODULE': '../build/python ../../Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '../build/python ../../Programs/_freeze_module.py',
    ...
    'HAVE__GETPTY': 0,
    'HAVE___UINT128_T': 1,
    'HOSTRUNNER': 'wasmtime run --mapdir /::/home/micro/projects/functionfly/runtimes/cpython-src --env PYTHONPATH=/builddir/wasi/build/lib.wasi-wasm32-3.13 /home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi/python.wasm --',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': '/home/micro/projects/functionfly/runtimes/wasi-sdk/bin/clang++ --sysroot=/home/micro/projects/functionfly/runtimes/wasi-sdk/share/wasi-sysroot -shared',
    'LDFLAGS': '',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': '/home/micro/projects/functionfly/runtimes/wasi-sdk/bin/clang --sysroot=/home/micro/projects/functionfly/runtimes/wasi-sdk/share/wasi-sysroot -shared',
    'LDVERSION': '3.13',
    'LIBC': '',
    ...
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': '/home/micro/projects/functionfly/runtimes/wasi-sdk/bin/clang --sysroot=/home/micro/projects/functionfly/runtimes/wasi-sdk/share/wasi-sysroot',
    'LINKFORSHARED': '',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': "_PYTHON_HOSTRUNNER='wasmtime run --mapdir /::/home/micro/projects/functionfly/runtimes/cpython-src --env PYTHONPATH=/builddir/wasi/build/lib.wasi-wasm32-3.13 /home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi/python.wasm --' _PYTHON_PROJECT_BASE=/home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi/`cat pybuilddir.txt`:)../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi ../build/python",
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': '../build/python',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': "_PYTHON_HOSTRUNNER='wasmtime run --mapdir /::/home/micro/projects/functionfly/runtimes/cpython-src --env PYTHONPATH=/builddir/wasi/build/lib.wasi-wasm32-3.13 /home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi/python.wasm --' _PYTHON_PROJECT_BASE=/home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi/`cat pybuilddir.txt`:)../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi ../build/python",
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': "_PYTHON_HOSTRUNNER='wasmtime run --mapdir /::/home/micro/projects/functionfly/runtimes/cpython-src --env PYTHONPATH=/builddir/wasi/build/lib.wasi-wasm32-3.13 /home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi/python.wasm --' _PYTHON_PROJECT_BASE=/home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi/`cat pybuilddir.txt`:)../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi ../build/python -m test",
    ...
    'abs_builddir': '/home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi',
    'abs_srcdir': '/home/micro/projects/functionfly/runtimes/cpython-src/builddir/wasi/../..',
