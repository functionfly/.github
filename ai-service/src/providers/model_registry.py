...
CURATED_MODELS: list[dict[str, Any]] = [
    ...
    _m("z-ai/glm-5.2", "GLM 5.2", "openrouter", "frontier", "$$", ["chat", "code", "tools"]),
    ...
    _m("qwen/qwen3.7-plus", "Qwen 3.7 Plus", "openrouter", "frontier", "$$", ["chat", "code", "tools"]),
    _m("nex-agi/nex-n2-pro", "Nex N2 Pro", "openrouter", "frontier", "$$", ["chat", "code", "tools"]),
    ...
    _m("openrouter/free", "Free Models Router", "openrouter", "fast", "free", ["chat", "code", "tools"]),
    ...
    _m("moonshotai/kimi-k2.7-code", "Kimi K2.7 Code", "openrouter", "code", "$$", ["chat", "code", "tools"]),
