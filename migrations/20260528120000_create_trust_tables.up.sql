-- Create trust system tables (missing from database)
-- These tables are required for the trust score API to work
...
CREATE TABLE IF NOT EXISTS execution_metrics (
    ...
    window_start TIMESTAMPTZ NOT NULL,
    window_end TIMESTAMPTZ NOT NULL,
    window_type VARCHAR(20) NOT NULL DEFAULT 'hourly',
