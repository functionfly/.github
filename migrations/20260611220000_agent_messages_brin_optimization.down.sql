...
CREATE INDEX idx_agent_messages_from_agent ON agent_messages (from_agent_id, created_at DESC);
...
CREATE INDEX idx_agent_messages_nonce ON agent_messages (nonce);