-- Fix: Create maintenance_windows table for status page
-- This separates scheduled maintenance windows from platform_maintenance (maintenance mode)
-- The status page handler needs this table with columns: title, status, scheduled_start, etc.
