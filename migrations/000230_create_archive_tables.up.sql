...
CREATE INDEX IF NOT EXISTS idx_archive_data_type ON archive_data (archive_type);
CREATE INDEX IF NOT EXISTS idx_archive_data_status ON archive_data (status);
CREATE INDEX IF NOT EXISTS idx_archive_data_created_at ON archive_data (created_at);
CREATE INDEX IF NOT EXISTS idx_archive_data_storage_key ON archive_data (storage_key);
...
CREATE INDEX IF NOT EXISTS idx_archive_cleanup_archive_id ON archive_cleanup_log (archive_id);
CREATE INDEX IF NOT EXISTS idx_archive_cleanup_operation ON archive_cleanup_log (operation);
CREATE INDEX IF NOT EXISTS idx_archive_cleanup_started_at ON archive_cleanup_log (started_at);
...
CREATE INDEX IF NOT EXISTS idx_archive_data_metadata_gin ON archive_data USING GIN (metadata_json);
