...
-- Note: Latest version index removed due to subquery limitation
-- Applications should use window functions or application-level logic for latest versions
...
CREATE TABLE IF NOT EXISTS agent_memories (
    ...
    -- Embedding (BYTEA when pgvector not installed)
    embedding BYTEA,
